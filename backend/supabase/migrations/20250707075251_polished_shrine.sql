/*
  ...
  1. New Functions
    - Add function to get permissions by role ID
    - Add function to get role permissions by name
    - Add function to assign permissions to a role

  2. Changes
    - Fix issues with role_permissions table structure
    - Ensure proper handling of both role IDs and role names
    - Add helper functions for permission management
...
-- Create a function to get role permissions by name
...
-- Create a function to assign permissions to a role
