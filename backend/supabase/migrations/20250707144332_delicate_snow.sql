/*
  ...
  1. Changes
    - Drop existing functions before recreating them with new signatures
    - Ensure get_permissions_by_role_id and assign_permissions_to_role can be properly redefined

  2. Security
    - Maintain existing RLS policies
*/

-- Drop existing functions to allow redefinition with new signatures
DROP FUNCTION IF EXISTS get_permissions_by_role_id(uuid);
