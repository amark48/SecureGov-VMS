/*
  ...
  1. Changes
    - Add a trigger function to validate invitation dates and times
    - Ensure invitations cannot be created with past dates or times
    - Add validation for recurrence end dates
